...
static class SceneAutoLoader {
    ...
    [MenuItem("File/Master Scene/Select Master Scene...")]
    ...
    [MenuItem("File/Master Scene/Reload Previous Scene", true)]
    private static bool ShowLoadMasterOnPlay() {
        return !LoadMasterOnPlay;
    }
    [MenuItem("File/Master Scene/Reload Previous Scene")]
    private static void EnableLoadMasterOnPlay() {
        LoadMasterOnPlay = true;
    }

    [MenuItem("File/Master Scene/Don't Reload Previous Scene", true)]
    private static bool ShowDontLoadMasterOnPlay() {
        return LoadMasterOnPlay;
    }
    [MenuItem("File/Master Scene/Don't Reload Previous Scene")]
    private static void DisableLoadMasterOnPlay() {
        LoadMasterOnPlay = false;
    }

    [MenuItem("File/Run Master Scene _F5")]
